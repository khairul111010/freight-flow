...
const SelectInput: FC<Props> = ({
    ...
    const sizeClass = {
        ...
        medium: `text-sm pl-[calc(1rem-8px)] h-[40px] !shadow-none ${
            noBorder
                ? "!border-none "
                : "!border-2 !border-[#E5E7EB] !rounded-[6px]"
        }`,
                    ...
                    control: ({ isFocused }) => {
                        return (
                            ...
                            (meta && meta.error && meta.touched
                                ? " !border-red-500 focus:!border-red-500 !bg-red-500/5 !border-[2px] !rounded-md"
                                : "")
                        );
                    },
