...
const SearchInput: FC<Props> = ({
    ...
    const sizeClass = {
        ...
        medium: 'text-base px-4 h-[49px] rounded-md',
    ...
    return (
        ...
        >
            <input
                className={`leading-[1.5] pr-6 w-full block outline-none border-2 border-gray-200 focus:border-primary ${sizeClass} ${className} pl-8`}
                {...rest}
            />
