...
const FileInput: FC<Props> = ({
    ...
    return (
        <div
            className={`mb-3 text-gray-500 ${typeof containerStyle === 'string' && containerStyle}`}
        ...
        >
            ...
            <div>
                ...
                >
                    ...
                    <div>
                        Drag and drop or{' '}
                        <span className='text-blue-500 underline'>Upload a file</span>
                    </div>
                </button>
            </div>
                ...
                {files.length > 0 &&
                    files.map((file, index) => (
                        <div key={index} className='flex items-center py-2'>
                            <AiOutlineFileText className='mr-3 text-[30px] text-gray-500' />
                            <div className='grow'>
